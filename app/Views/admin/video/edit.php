...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="text" name="judul" class="form-control" placeholder="Nama video" value="<?php echo $video['judul'] ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="text" name="video" class="form-control" placeholder="Link video youtube" value="<?php echo $video['video'] ?>" required>
...
<div class="form-group row">
	...
	<div class="col-9">
		<textarea name="keterangan" rows="4" class="form-control"><?php echo $video['keterangan'] ?></textarea>
	</div>
</div>
