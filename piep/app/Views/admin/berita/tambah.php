	...
	<div class="row">
		<div class="col-lg-9">
			<div class="form-group">
				...
				<textarea name="isi" class="form-control konten" style="height: 910px;"><?php echo set_value('isi') ?></textarea>
			</div>
		</div>
		<div class="col-lg-3">
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea name="keywords" class="form-control" style="height: 148px;"><?php echo set_value('keywords') ?></textarea>
			</div>
