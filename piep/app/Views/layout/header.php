...
<div id="topbar" class="d-flex align-items-center fixed-top">
  <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
    ...
    <a id="whatshapSiswa" href="https://api.whatsapp.com/send?phone=<?php echo telepon() ?>" class="text-white" style="border-radius: 20px;border: 0px;">
      <div class="d-flex align-items-center">
        <i class="fab fa-whatsapp"></i> +<?php echo telepon() ?>
      </div>
    </a>
  </div>
</div>
  ...
  <div class="container d-flex align-items-center">
    ...
    <nav id="navbar" class="navbar order-last order-lg-0">
      <ul>
        ...
        <li><a class="nav-link scrollto" href="<?php echo base_url('download') ?>">Belanja</a></li>
