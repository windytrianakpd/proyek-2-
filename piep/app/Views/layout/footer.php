      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="footer-info">
            ...
            <br>
            <p><strong>Phone:</strong> <?php echo $site['hp'] ?></p>
            <p><strong>Email:</strong> <?php echo $site['email'] ?></p>
...
<script>
  $("a#whatshapSiswa").click(function(e) {
    e.preventDefault();
...
<script>
  ...
  if (flashData) {
    Swal.fire({
      type: 'success',
      title: 'Order sedang dalam proses',
